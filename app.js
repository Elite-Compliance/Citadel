...
var pages=[{id:"command-center",label:"Command Center"},{id:"region-health",label:"Region Health"},{id:"data-connections",label:"Data Connections"},{id:"inbox",label:"Inbox"},{id:"tasks",label:"Tasks"},{id:"legal",label:"Legal"},{id:"reviews",label:"Reviews"},{id:"pricing",label:"Material Pricing"},{id:"labor-pricing",label:"Labor Pricing"},{id:"templates",label:"Templates"},{id:"orders",label:"Orders"},{id:"crew-pay",label:"Labor Invoices"},{id:"fleet",label:"Fleet",children:[{id:"fleet-vehicles",label:"Vehicles"},{id:"fleet-drivers",label:"Drivers"}]},{id:"contractors",label:"Subcontractors/Crews"},{id:"suppliers",label:"Suppliers"},{id:"registrations",label:"Registrations"},{id:"liens",label:"Liens"},{id:"collections",label:"Collections"}];
...
var contractorFilters={status:"All",region:"All regions",sort:"Highest risk",search:""};
...
function normalizeContractorRecord(row){
  return {
    ...
    active:row.active!==undefined&&row.active!==null?String(row.active):String(row.Active||""),
...
function getContractorStatus(row){return /^(yes|true|active|1)$/i.test(String(row&&row.active||"").trim())?"Active":"Inactive"}
...
var DATA_CONNECTION_LINKS={
  ...
  ordersWorkflow:'https://github.com/Elite-Compliance/Citadel/actions/workflows/blaze-orders-import.yml',
  crewPayWorkflow:'https://github.com/Elite-Compliance/Citadel/actions/workflows/blaze-crew-pay-import.yml',
  ...
  blazeOrders:'https://blaze-crm.com/64daaf06-5043-4886-b9a2-1362e47b0b65/production-dashboard/production-orders',
  blazeCrewPay:'https://blaze-crm.com/64daaf06-5043-4886-b9a2-1362e47b0b65/production-dashboard/production-invoices',
...
var PROTECTED_DATA_CONNECTIONS=[
  ...
  {name:'Orders',detail:'Order headers, material and labor lines, pricing exceptions, and import history',id:'1peF6ujpJGi_vugM7hanoL06KLNUC_tarAOoW2dW6QfQ'},
  {name:'Crew Pay',detail:'Crew invoices, invoice lines, rate comparisons, exceptions, and rate analysis',id:'1peF6ujpJGi_vugM7hanoL06KLNUC_tarAOoW2dW6QfQ'},
...
function renderDataConnectionsPage(){
  ...
  pagePanel.innerHTML=renderModuleStatusLine(connected+' of '+modules.length+' source connections available')+
    ...
    '<section class="data-connections-section"><div class="card-heading"><h3>Automation & Import Tools</h3><span>Sources, schedules, and controls</span></div><div class="data-import-grid">'+
      ...
      '<article class="data-import-card"><div><span>Blaze Production Orders</span><h3>Orders & Pricing Comparison</h3><p>Cross-region order discovery, material and labor line detail, and comparison with protected pricing.</p><small>Manual validation workflow; scheduling remains disabled until the first imports are approved.</small></div><div class="data-card-actions">'+dataConnectionLink(DATA_CONNECTION_LINKS.blazeOrders,'Source Workspace',true)+dataConnectionLink(DATA_CONNECTION_LINKS.ordersWorkflow,'Import Runs',true)+'</div></article>'+
      '<article class="data-import-card"><div><span>Blaze Production Invoices</span><h3>Crew Pay Comparison</h3><p>Cross-region crew invoices and line detail compared with job-order labor and master labor pricing.</p><small>Manual validation workflow; scheduling remains disabled until the first imports are approved.</small></div><div class="data-card-actions">'+dataConnectionLink(DATA_CONNECTION_LINKS.blazeCrewPay,'Source Workspace',true)+dataConnectionLink(DATA_CONNECTION_LINKS.crewPayWorkflow,'Import Runs',true)+'</div></article>'+
    '</div></section>'+
