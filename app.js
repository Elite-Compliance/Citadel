...
function renderCrewPayModule(){pagePanel.className="page-panel registrations-module-page";pagePanel.innerHTML='<iframe class="registrations-module-frame" title="Crew Pay workspace" src="./modules/crew-pay/index.html?v=1.0.0"></iframe>'}
