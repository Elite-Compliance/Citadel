...
function renderDataConnectionsPage(){
  ...
  pagePanel.innerHTML=renderModuleStatusLine(connected+' of '+modules.length+' source connections available')+
    ...
    '<section class="data-connections-section"><div class="card-heading"><h3>Protected Import Tools</h3><span>Manual controls</span></div><div class="data-import-grid">'+
      ...
      '<article class="data-import-card"><div><span>Geotab Fleet Report</span><h3>Fleet Devices</h3><p>Validate VINs, serial numbers, duplicate devices, and publish the protected Fleet snapshot.</p><small>'+escapeHtml(fleetSchedule)+'</small></div><button type="button" data-run-fleet-import>Fleet Import</button></article>'+
    '</div></section>'+
