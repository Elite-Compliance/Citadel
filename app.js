...
function renderTemplatesModule(){pagePanel.className="page-panel registrations-module-page";pagePanel.innerHTML='<iframe class="registrations-module-frame" title="Templates workspace" src="./modules/templates/index.html?v=1.1.5"></iframe>'}
