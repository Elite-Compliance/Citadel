...
const CITADEL_USER_HEADERS = ['user_id', 'email', 'display_name', 'role', 'modules', 'regions', 'permissions', 'status', 'password_salt', 'password_hash', 'password_iterations', 'password_changed_at', 'must_change_password', 'failed_login_co…53631 tokens truncated…orney|legal/i.test(String(status || ''))) return 'Review';
  return 'Monitor';
}
